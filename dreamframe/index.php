...
<head>
    ...
    <meta property="og:url" content="https://rvrjcce.ac.in/xcsm/aikshetra2K25/dreamframe/">
        ...
        <section class="events">
            <div class="container event-details-page">
                ...
                <section class="event-detail-block" id="certificates">
                    ...
                    <p>
                        Download your <strong>e-certificate of participation</strong> for <strong>DreamFrame</strong> by entering your registered mobile number below.
                    </p>
                    ...
                    <script>
                        document.getElementById("certificate-form").addEventListener("submit", async function(e) {
                            ...
                            const EVENT_CODE = "DF"; // DreamFrame
